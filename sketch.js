...
function setup() {
  ...
  block29 = new Block(730,175,30,40);
  block28 = new Block(760,175,30,40);
  block27 = new Block(790,175,30,40);
  //level two
  block18 = new Block(640,135,30,40);
  block19 = new Block(670,135,30,40);
  block31 = new Block(700,135,30,40);
  block23 = new Block(730,135,30,40);
  block22 = new Block(760,135,30,40);
  //level three
  block23 = new Block(670,95,30,40);
  block24 = new Block(700,95,30,40);
  block25 = new Block(730,95,30,40);
  //top
  block26 = new Block(700,55,30,40); 
